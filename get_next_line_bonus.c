...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/02/21 18:58:03 by pshamkha          #+#    #+#             */
/*   Updated: 2024/02/21 18:59:25 by pshamkha         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*get_next_line(int fd)
{
	...
	file[fd] = get_file(fd, file[fd]);
	if (file[fd] == NULL)
		return (NULL);
	line = get_linef(file[fd]);
	file[fd] = set_file(file[fd]);
	return (line);
}
